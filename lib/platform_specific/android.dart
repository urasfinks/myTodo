...
const debugChannel = AndroidNotificationChannel(
  'debug',
  'Debug',
  description: 'This channel is used to demo all notifications manually for development/debug purposes.',
...
const toiletPaperChannel = AndroidNotificationChannel(
  'toilet_paper',
  'Toilet Paper',
  description: 'This channel is used to notify you when toilet paper has run out.',
  importance: Importance.max,
);

final _flutterLocalNotifications =
